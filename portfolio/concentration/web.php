...
<div class="container">
  <div class="row">
	<div class="col-sm-4 left-box">
        <div class="thumbnail">
            <img src="../img/collins.png" alt="Deborah Youngblood" class="image">
            <div class="middle">
               <div class=" text"><a href="mailto:chmosque@uiwtx.edu?Subject=Hello%20again" target="_top">email</a></div>
            </div>
